...
export default function Leave() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setApprovedApplications(data.filter(app => app.applicationStatus === "approved"));
            setRejectedApplications(data.filter(app => app.applicationStatus === "rejected"));
            setLoading(false);
        };
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 ml-10">Leave Applications</h1>
            <Divider />
            <TabView>
                ...
                <TabPanel header="History">
                    <DataTable value={[...approvedApplications, ...rejectedApplications]} paginator rows={5} loading={loading}sortField="dateSubmitted" sortOrder={-1}>
                    <Column field="workerId" header="Worker ID" style={{ color: "black", backgroundColor: "white" }}></Column>
                        <Column field="workerName" header="Worker Name" style={{ color: "black", backgroundColor: "white" }}></Column>
                        <Column field="leaveType" header="Leave Type" style={{ color: "black", backgroundColor: "white" }}></Column>
                        <Column field="dateSubmitted" header="Date Submitted" sortable style={{ color: "black", backgroundColor: "white" }}></Column>
